/*
 * (C)Copyright Fernando Martinez
 * A simple crossword viewer and interactive solver
 * License: LGPL
 * Released under the more liberal LGPL license to allow you to use it in open source and commercial applications. In summary, if I understood it well:
 * If you link to the code as in including it and calling it in your software, you are not obliged to release your source code,
 * but direct modifications of this source code must be released open source to allow the community and the project to benefit.
 * ----------------------------------------------------------
...
Crossword.prototype = {
    ...
    mouseDown:function (evt)  {
    	if (evt.shiftKey) { cw.toggleDir(); cw.showCursor();return}
    	cw.resetColorMap();
    ...
    parseData:function(data) {
        ...
        this.initArrays();
        horz = $(data).find('horizontals');
        words = horz.find('word');
        this.parseWords(words, 0);
        verts = $(data).find('verticals');
